...
`},{"@parcel/transformer-js/src/esmodule-helpers.js":"9p1zA"}],bEGKb:[function(e,t,a,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(a),r.export(a,"ensureOcrEngine",()=>s);var i=e("../index"),o=e("./bar");async function l(){return i.LIA.tfjs&&i.LIA.tfjs.pipeline?i.LIA.tfjs:(i.LIA.tfjsLoad=i.LIA.tfjsLoad||(async()=>{let e=null;for(let t of["https://cdn.jsdelivr.net/npm/@xenova/transformers@2.17.2/+esm","https://esm.sh/@xenova/transformers@2.17.2?bundle"])try{try{let e=i.LIA.bar;e&&e.log&&e.log("Importing Transformers.js: "+t)}catch(e){}let e=await Function("u","return import(u)")(t),a=e.pipeline||e.default&&e.default.pipeline,n=e.env||e.default&&e.default.env;if(!a||!n)throw Error("Transformers.js ESM export missing (pipeline/env).");let r={pipeline:a,env:n,__url:t};return i.LIA.tfjs=r,r}catch(a){e=a;try{let e=i.LIA.bar;e&&e.log&&e.log("Import failed: "+t+" — "+(a&&a.message?a.message:String(a)))}catch(e){}}throw e||Error("Failed to load Transformers.js from all CDN URLs.")})(),await i.LIA.tfjsLoad)}function s(){if(i.LIA.ocr)return i.LIA.ocr;let e=(0,o.ensureOcrBar)(),t={model:e.get().model||"Xenova/trocr-small-handwritten",task:"image-to-text",precision:e.get().precision||"fp32",pipe:null,loading:null,async setModel(t){let a=String(t||this.model||"Xenova/texify2");return this.model=a,e.set({model:a,loaded:!1,status:"idle",phase:"idle",progress:null}),this.pipe=null,this.loading=null,this.ensureLoaded(!0)},async setPrecision(t){let a=String(t||"fp32");return this.precision=a,e.set({precision:a,loaded:!1,status:"idle",phase:"idle",progress:null}),this.pipe=null,this.loading=null,this.ensureLoaded(!0)},async ensureLoaded(t){if(this.pipe&&!t)return this.pipe;if(this.loading)return this.loading;let a=this.precision||"fp32",n={fp32:"fp32",fp16:"fp16",int8:"q8"}[a]||"fp32";e.set({model:this.model,backend:"wasm",precision:a,status:"loading",phase:"import",loaded:!1,progress:0}),e.log("Loading model ("+a+") …");let r=null,i=new Promise((e,t)=>{r=setTimeout(()=>t(Error("OCR model load timed out after 60s")),6e4)});return this.loading=(async()=>{try{let{pipeline:t,env:r}=await Promise.race([l(),i]);try{r.allowLocalModels=!1,r.allowRemoteModels=!0,r.useBrowserCache=!0,r.backends=r.backends||{},r.backends.onnx=r.backends.onnx||{},r.backends.onnx.wasm=r.backends.onnx.wasm||{}}catch(e){}e.set({phase:"pipeline"});let o=await Promise.race([t(this.task,this.model,{dtype:n,progress_callback:t=>{let a=function(e){try{if(null==e)return null;if("number"==typeof e&&isFinite(e))return Math.max(0,Math.min(1,e));let t=e&&"object"==typeof e?e:null;if(!t)return null;if(isFinite(t.progress))return Math.max(0,Math.min(1,Number(t.progress)));if(isFinite(t.loaded)&&isFinite(t.total)&&Number(t.total)>0)return Math.max(0,Math.min(1,Number(t.loaded)/Number(t.total)))}catch(e){}return null}(t);null!==a&&e.set({progress:a,phase:"download"})}}),i]);return this.pipe=o,e.set({status:"ready",phase:"ready",loaded:!0,progress:null}),e.log("Model loaded ("+a+")."),o}catch(t){throw e.set({status:"error",phase:"error",loaded:!1,progress:null}),e.log("Load failed: "+(t&&t.message?t.message:String(t))),t}finally{null!==r&&clearTimeout(r),this.loading=null}})(),this.loading},async recognize(t,a){let n=a&&"object"==typeof a?a:{},r=!0===n.__silent,i=await this.ensureLoaded(!1);e.set({status:"working",phase:"infer",progress:null});let o=null;async function l(e){if(e&&"function"==typeof e.convertToBlob)return await e.convertToBlob({type:"image/png"});if(e&&"function"==typeof e.toBlob)return await new Promise((t,a)=>{e.toBlob(e=>e?t(e):a(Error("toBlob() returned null")),"image/png")});throw Error("Canvas-like has no toBlob/convertToBlob")}async function s(e){if("string"==typeof e)return{input:e,revoke:null};if(e&&"object"==typeof e&&"function"==typeof e.arrayBuffer&&"number"==typeof e.size&&"string"==typeof e.type){let t=URL.createObjectURL(e);return{input:t,revoke:()=>URL.revokeObjectURL(t)}}if(e&&"object"==typeof e&&"number"==typeof e.width&&"number"==typeof e.height&&e.data&&"number"==typeof e.data.length){let t=document.createElement("canvas");t.width=Math.max(1,Math.floor(e.width)),t.height=Math.max(1,Math.floor(e.height)),t.getContext("2d",{willReadFrequently:!0}).putImageData(e,0,0);let a=await l(t),n=URL.createObjectURL(a);return{input:n,revoke:()=>URL.revokeObjectURL(n)}}if(e&&"object"==typeof e){if("function"==typeof e.toDataURL)return{input:e.toDataURL("image/png"),revoke:null};if("function"==typeof e.toBlob||"function"==typeof e.convertToBlob){let t=await l(e),a=URL.createObjectURL(t);return{input:a,revoke:()=>URL.revokeObjectURL(a)}}}throw Error("Unsupported input type for OCR: "+(null===e?"null":typeof e))}try{let a=await s(t);o=a.revoke;let l="number"==typeof n.max_new_tokens&&isFinite(n.max_new_tokens)?Math.max(1,Math.floor(n.max_new_tokens)):96,c=await i(a.input,{max_new_tokens:l,do_sample:!0===n.do_sample,temperature:"number"==typeof n.temperature&&isFinite(n.temperature)?n.temperature:0}),d="";if("string"==typeof c)d=c;else if(Array.isArray(c)&&c.length){let e=c[0]||{};(d=e.generated_text||e.text||e.latex||"")||(d=JSON.stringify(e))}else c&&"object"==typeof c?(d=c.generated_text||c.text||c.latex||"")||(d=JSON.stringify(c)):d=String(c);return e.set({status:"ready",phase:"ready"}),r||e.log("Recognize done."),d}catch(t){throw e.set({status:"error",phase:"error"}),r||e.log("Recognize failed: "+(t&&t.message?t.message:String(t))),t}finally{try{o&&o()}catch(e){}}}};return i.LIA.ocr=t,t}},{"../index":"bZBjE","./bar":"hlAaK","@parcel/transformer-js/src/esmodule-helpers.js":"9p1zA"}],cCz1j:[function(e,t,a,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(a),r.export(a,"cfUnionBBox",()=>g),r.export(a,"ensureCanvasFreezeApi",()=>E);var i=e("../index"),o=e("./store"),l=e("./theme");function s(e,t){let a=Number(e);return isFinite(a)?a:t||0}function c(e,t,a){return Math.max(t,Math.min(a,e))}function d(e){return Math.round(100*s(e,0))/100}function p(e,t){let a=s(t,0);if(!(a>0))return 0;let n=s(e,0)%a;return n<0?n+a:n}function u(e){let t=e&&"object"==typeof e?e:{};return{panX:s(t.panX,0),panY:s(t.panY,0),scale:s(t.scale,1)||1,minScale:s(t.minScale,.25),maxScale:s(t.maxScale,8)}}function h(e,t){let a=s(e&&e.x,0),n=s(e&&e.y,0),r=s(t&&t.scale,1)||1;return{x:a*r+s(t&&t.panX,0),y:n*r+s(t&&t.panY,0)}}function f(e,t,a){if(!e)return null;let n=Math.max(0,s(e.x,0)),r=Math.max(0,s(e.y,0)),i=Math.min(s(t,0),s(e.x,0)+s(e.w,0)),o=Math.min(s(a,0),s(e.y,0)+s(e.h,0));return i<=n||o<=r?null:{x:n,y:r,w:i-n,h:o-r}}function g(e,t){if(!e)return t?{x:t.x,y:t.y,w:t.w,h:t.h}:null;if(!t)return{x:e.x,y:e.y,w:e.w,h:e.h};let a=Math.min(e.x,t.x),n=Math.min(e.y,t.y);return{x:a,y:n,w:Math.max(0,Math.max(e.x+e.w,t.x+t.w)-a),h:Math.max(0,Math.max(e.y+e.h,t.y+t.h)-n)}}function m(e){return e&&e.querySelector?e.querySelector(".lia-canvas-mount"):null}function x(e){let t=m(e);return t?(0,o.ensureMountUID)(t):""}function b(e){let t=i.LIA.store||{};return e&&t[e]?t[e]:null}function y(e){return Array.from((e&&e.querySelectorAll?e:document).querySelectorAll(".lia-canvas-pair")).filter(e=>!!m(e))}function v(e,t){let a=Array.isArray(t)?t:[];for(let t=0;t<a.length;t++){let n=a[t];if(!n)continue;if("r"===n.k){e.save(),e.globalCompositeOperation="source-over",e.globalAlpha=1,e.fillStyle=String(n.f||"rgba(0,0,0,0.15)"),e.fillRect(s(n.x,0),s(n.y,0),Math.max(0,s(n.w,0)),Math.max(0,s(n.h,0))),e.restore();continue}let r=Array.isArray(n.p)?n.p:[];if(r.length){e.save(),e.beginPath(),e.moveTo(s(r[0][0],0),s(r[0][1],0));for(let t=1;t<r.length;t++)e.lineTo(s(r[t][0],0),s(r[t][1],0));e.lineCap="round",e.lineJoin="round",e.lineWidth=Math.max(.75,s(n.w,1)),"e"===n.k?(e.globalCompositeOperation="destination-out",e.globalAlpha=1,e.strokeStyle="rgba(0,0,0,1)"):(e.globalCompositeOperation="source-over",e.globalAlpha=c(s(n.a,1),0,1),e.strokeStyle=String(n.c||"#000")),e.stroke(),e.restore()}}}function w(e,t){let a,n,r;if(!e||!t)return null;let i=function(e){let t=e&&"object"==typeof e?e:{},a=Array.isArray(t.ITEMS)?t.ITEMS:[],n=u(t.VIEW||{}),r=Math.max(1,Math.round(s(t.wrapW,0))),i=Math.max(1,Math.round(s(t.canvasH,0))),o=(0,l.rgbaFromAny)((0,l.getAccentCssVar)(),.28),p=[];for(let e=0;e<a.length;e++){let t=a[e];if(t&&"object"==typeof t){if("path"===t.kind){let e=Array.isArray(t.points)?t.points:[];if(!e.length)continue;let a=e.map(e=>h(e,n)),o=Math.max(.75,s(t.width,1)*s(n.scale,1));if(!f(function(e,t){let a=Array.isArray(e)?e:[];if(!a.length)return null;let n=1/0,r=1/0,i=-1/0,o=-1/0;for(let e=0;e<a.length;e++){let t=a[e],l=s(t&&t.x,0),c=s(t&&t.y,0);l<n&&(n=l),c<r&&(r=c),l>i&&(i=l),c>o&&(o=c)}let l=Math.max(0,s(t,0));return{x:n-l,y:r-l,w:Math.max(0,i-n+2*l),h:Math.max(0,o-r+2*l)}}(a,o/2+2),r,i))continue;p.push({k:"eraser"===t.tool?"e":"p",c:String(t.color||(0,l.getAutoPen)()),a:c(s(t.alpha,1),0,1),w:d(o),p:a.map(e=>[d(e.x),d(e.y)])});continue}if("rect"===t.kind){let e=h({x:t.x0,y:t.y0},n),a=h({x:t.x1,y:t.y1},n),u=function(e,t,a,n){let r=Math.min(s(e,0),s(a,0)),i=Math.min(s(t,0),s(n,0));return{x:r,y:i,w:Math.max(0,Math.max(s(e,0),s(a,0))-r),h:Math.max(0,Math.max(s(t,0),s(n,0))-i)}}(e.x,e.y,a.x,a.y);if(!f(u,r,i))continue;let g=c(s(t.alpha,.28),0,1),m=t.color?(0,l.rgbaFromAny)(t.color,g):(0,l.rgbaFromAny)((0,l.getAccentCssVar)(),g);p.push({k:"r",f:m||o,x:d(u.x),y:d(u.y),w:d(u.w),h:d(u.h)})}}}return{vw:r,vh:i,items:p}}(t),o=Math.max(1,0|i.vw),g=Math.max(1,0|i.vh),m=Array.isArray(i.items)?i.items:[],x=document.createElement("canvas");x.width=o,x.height=g;let b=x.getContext("2d",{willReadFrequently:!0});b.clearRect(0,0,o,g),v(b,m);let y=function(e){if(!e)return null;let t=e.getContext("2d",{willReadFrequently:!0});if(!t)return null;let a=0|e.width,n=0|e.height;if(!(a>0&&n>0))return null;let r=t.getImageData(0,0,a,n).data,i=a,o=n,l=-1,c=-1;for(let e=0;e<n;e++){let t=e*a*4;for(let n=0;n<a;n++)!(r[t+4*n+3]<=10)&&(n<i&&(i=n),e<o&&(o=e),n>l&&(l=n),e>c&&(c=e))}if(l<0)return null;let d=Math.max(0,Math.round(s(8,0)));return{x:Math.max(0,i-d),y:Math.max(0,o-d),w:Math.max(1,Math.min(a-1,l+d)-Math.max(0,i-d)+1),h:Math.max(1,Math.min(n-1,c+d)-Math.max(0,o-d)+1)}}(x);return y?{v:"cvf1",u:String(e),w:y.w,h:y.h,bg:function(e,t){let a=e&&"object"==typeof e?e:{},n=u(a.VIEW||{}),r=String(a.bgMode||"none");if("grid"!==r&&"lined"!==r)return{m:"none"};let i=Math.max(1,s(a.bgStep,24))*Math.max(1e-4,s(n.scale,1));if(!(i>0))return{m:"none"};let o=s(t&&t.x,0),c=s(t&&t.y,0);return{m:r,s:d(i),ox:d(p(s(n.panX,0)-o,i)),oy:d(p(s(n.panY,0)-c,i)),c:(0,l.rgbaFromAny)((0,l.getAccentCssVar)(),.65),lw:1.125}}(t,y),it:(a=Array.isArray(m)?m:[],n=s(y&&y.x,0),r=s(y&&y.y,0),a.map(e=>e?"r"===e.k?{k:"r",f:String(e.f||""),x:d(s(e.x,0)-n),y:d(s(e.y,0)-r),w:d(s(e.w,0)),h:d(s(e.h,0))}:{k:"e"===e.k?"e":"p",c:String(e.c||""),a:c(s(e.a,1),0,1),w:d(s(e.w,1)),p:(Array.isArray(e.p)?e.p:[]).map(e=>[d(s(e&&e[0],0)-n),d(s(e&&e[1],0)-r)])}:null).filter(Boolean))}:{v:"cvf1",u:String(e),e:1,w:0,h:0,bg:{m:"none"},it:[]}}function k(e){let t=x(e);if(!t)return null;let a=b(t);return a?w(t,a):null}function M(e){let t=y(e),a=[];for(let e=0;e<t.length;e++){let n=k(t[e]);n&&a.push(n)}return a}function _(e){return!!(e&&1!==e.e&&s(e.w,0)>0&&s(e.h,0)>0&&Array.isArray(e.it)&&e.it.length)}function S(e,t){if(!e||!t)return null;let a=Math.max(1,Math.round(s(t.w,1))),n=Math.max(1,Math.round(s(t.h,1))),r=window.devicePixelRatio||1;e.width=Math.max(1,Math.round(a*r)),e.height=Math.max(1,Math.round(n*r)),e.style.width=a+"px",e.style.height=n+"px";let i=e.getContext("2d",{willReadFrequently:!0});return i.setTransform(r,0,0,r,0,0),i.clearRect(0,0,a,n),!function(e,t,a,n){let r=t&&"object"==typeof t?t:{},i=String(r.m||"none");if("grid"!==i&&"lined"!==i)return;let o=Math.max(1,s(r.s,1)),c=p(s(r.ox,0),o),d=p(s(r.oy,0),o),u=String(r.c||(0,l.rgbaFromAny)((0,l.getAccentCssVar)(),.65)),h=Math.max(.5,s(r.lw,1.125));if(e.save(),e.globalCompositeOperation="source-over",e.globalAlpha=1,e.strokeStyle=u,e.lineWidth=h,e.beginPath(),"grid"===i){for(let t=c;t<=a;t+=o)e.moveTo(t,0),e.lineTo(t,n);for(let t=d;t<=n;t+=o)e.moveTo(0,t),e.lineTo(a,t)}else for(let t=d;t<=n;t+=o)e.moveTo(0,t),e.lineTo(a,t);e.stroke(),e.restore()}(i,t.bg||{m:"none"},a,n),v(i,Array.isArray(t.it)?t.it:[]),e}function C(e,t){if(!e||!(e instanceof Element)||!t)return null;if(e.dataset.open="1",e.innerHTML="",!_(t)){let t=document.createElement("span");return t.className="lia-canvas-freeze-empty",t.textContent="No visible canvas content frozen.",e.appendChild(t),t}let a=document.createElement("span");a.className="lia-draw-block";let n=document.createElement("span");n.className="lia-draw-wrap";let r=document.createElement("canvas");return r.className="lia-canvas-freeze-preview",r.setAttribute("aria-label","Frozen drawing area"),n.appendChild(r),a.appendChild(n),e.appendChild(a),S(r,t),r}function A(e,t){let a=m(e);return a?C(a,t):null}function E(){let e=i.LIA.freeze||{};return e.version="cvf1",e.collectCanvasPairsFromRoot=y,e.getCanvasMountFromPair=m,e.getCanvasUidFromPair=x,e.getCanvasStoreEntry=b,e.exportCanvasFreezeStateFromEntry=w,e.exportCanvasFreezeStateFromPair=k,e.exportAllCanvasFreezeStatesFromRoot=M,e.hasCanvasFreezeContent=_,e.paintCanvasFreezeStateToCanvas=S,e.renderCanvasFreezeStateIntoMount=C,e.renderCanvasFreezeStateIntoPair=A,i.LIA.freeze=e,e}},{"../index":"bZBjE","./store":"bxEU5","./theme":"9gAEw","@parcel/transformer-js/src/esmodule-helpers.js":"9p1zA"}],bxEU5:[function(e,t,a,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(a),r.export(a,"ensureMountUID",()=>o),r.export(a,"__liaDispatchCanvasFreezeChange",()=>l);var i=e("../index");function o(e){if(!e)return"";if(e.dataset&&e.dataset.uid)return e.dataset.uid;let t="c"+ ++i.LIA.uidSeq;return e.dataset.uid=t,t}function l(e){try{let t=Object.assign({ts:Date.now()},e&&"object"==typeof e?e:{}),a=(0,i.getRootWindow)();(a&&"function"==typeof a.dispatchEvent?a:window).dispatchEvent(new CustomEvent("lia:canvas-change",{detail:t}))}catch(e){}}},{"../index":"bZBjE","@parcel/transformer-js/src/esmodule-helpers.js":"9p1zA"}],"2KvOo":[function(e,t,a,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(a),r.export(a,"ensureCanvasFreezeApi",()=>s.ensureCanvasFreezeApi),r.export(a,"canvasMarkup",()=>d),r.export(a,"initAll",()=>p);var i=e("../index"),o=e("./theme"),l=e("./store"),s=e("./freeze"),c=e("../lia/input");function d(){return`
  ...
  `}function p(){document.querySelectorAll(".lia-draw-wrap canvas.lia-draw:not([data-ready])").forEach(e=>{e.setAttribute("data-ready","1"),function(e){let t=e.closest(".lia-draw-wrap");if(!t)return;let a=t.closest(".lia-canvas-mount"),n=(0,l.ensureMountUID)(a),r=t.querySelector(".lia-undo-btn"),s=t.querySelector(".lia-redo-btn"),d=t.querySelector(".lia-color-btn"),p=t.querySelector(".lia-eraser-btn"),u=t.querySelector(".lia-rect-btn"),h=t.querySelector(".lia-bgmenu-btn"),f=t.querySelector(".lia-tool-menu"),g=document.createElement("button");g.type="button",g.className="lia-rect-action",g.textContent="Select & Submit",g.style.display="none",t.appendChild(g);let m=document.createElement("div");m.className="lia-rect-progress",m.dataset.on="0",m.innerHTML=`
